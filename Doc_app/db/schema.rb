...
ActiveRecord::Schema.define(version: 2019_08_02_004234) do
  ...
  create_table "join_tables_doctor_specialities", force: :cascade do |t|
    t.integer "doctor_id"
    t.integer "speciality_id"
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["doctor_id"], name: "index_join_tables_doctor_specialities_on_doctor_id"
    t.index ["speciality_id"], name: "index_join_tables_doctor_specialities_on_speciality_id"
  end
